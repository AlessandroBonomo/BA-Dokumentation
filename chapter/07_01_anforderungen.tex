...
In der Tabelle \ref{aktoren} befinden sich die Aktoren, welche mit der Anwendung interagieren. 
\begin{table}[H]
	\centering
	...
	\midrule
	Mail Server & Der Mail Server dient zum versenden von Nachrichten, falls zum Beispiel eine Lehrperson ein Feedback an einen Lernenden schicken möchte. \\
	\bottomrule
	\end{tabu}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Der ändert die Angaben zu einer bereists existierenden Person. 
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	\item Hauptszenario:
	\begin{itemize}
		\item Der Lehrer kann neue Aufgaben erstellen und diese einem Thema zuweisen. Pro Aufgabe gibt es mehrere Fragen, welche wiederum mehrere Hifestellungen enthalten können. Für jede Frage kann auch eine Punktzahl angegeben werden. 
	\end{itemize}
	\item Alternatives Szenario:
	\begin{itemize}
...
\begin{itemize}
	...
	\item Alternatives Szenario:
	\begin{itemize}
		\item Der Lehrer kann zugewiesene Aufgaben auch auf andere Tage verschieben.
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item Alternatives Szenario:
	\begin{itemize}
		\item Bemerkgt der Lehrer, dass einzelne Schüler ein Thema noch nicht ganz verstanden hat, kann er die Unklarheiten individueller Schüler klären.
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	\item Hauptszenario:
	\begin{itemize}
		\item Treten beim Lösen von Aufgaben Unklarheiten auf, kann ein Schüler diese direkt im aufgabenspezifischen Forum stellen.
	\end{itemize}
	\item Alternatives Szenario:
	\begin{itemize}
...
\begin{itemize}
	\item Hauptszenario:
	\begin{itemize}
		\item Der Lehrer hat die Möglichkeit, gelöste Aufgaben an die Schüler zurück zu weisen. Ist dies der Fall, wird eine E-Mail an den Schüler mit dem Feedback des Lehrers gesendet.
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item Alternatives Szenario:
	\begin{itemize}
		\item Falls der Lehrer die Übung eines Schülers zurück weist, kann dieser die Fragen nochmals überarbeiten.
	\end{itemize}
\end{itemize}
