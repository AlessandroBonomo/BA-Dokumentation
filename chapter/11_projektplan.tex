...
\begin{minipage}{\textwidth}
	\begin{figure}[H]
		...
		\caption{Zeitaufwand nach Mitglieder}
...
Die Abbildung \ref{time_per_Week} zeigt, wie viel Zeit jedes Projektmitglied pro Woche in die Arbeit investiert hat. Durch Job und andere Module, entstanden gewisse Schwankungen im Zeitaufwand pro Woche. Dennoch ist es beiden Projektmitgliedern gelungen, den geforderten Zeitaufwand von je 300 Studnen zu leisten.
