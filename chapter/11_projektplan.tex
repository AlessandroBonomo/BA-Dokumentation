...
Die Teammitglieder arbeiten an mindestens zwei Tagen pro Woche zusammen im Bachelorarbeitszimmer. So können Fragen schnell geklärt werden und es kann sich gegenseitig geholfen werden. Im Normalfall findet jeden Donnerstag ein Meeting mit dem Betreuer Frank Koch statt, in dem der aktuelle Stand vorgestellt, Probleme besprochen und das weitere Vorgehen besprochen wird. Da der Betreuer jedoch oft unterwegs war, wurde oft eine Telefonkonferenz gemacht.
...
Zudem wird Travis CI verwendet, welches nach jedem Push die Tests durchführt. Somit kann man sich auch sicher sein, dass sämtlicher Code auch wirklich alle Tests besteht.
...
Als IDE wurde sich auf PyCharm von JetBrains. Dies hat den Vorteil, dass man sich beim Pair Programming schnell zurecht finded. \\
Als Projektmanagement Tool wird Jira eingesetzt. \\
Die Dokumentation und der Projektplan werden mit \LaTeX erstellt. Kleinere Dokumente oder das Sitzungsprotokoll werden mit Word gemacht. 
