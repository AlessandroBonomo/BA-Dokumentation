...
Bei der Wahl des Frontend Frameworks wurde zwischen Semantic-UI und Bootstrap entschieden. Ein wichtiger Vorteil von Semantic-UI gegenüber Bootstrap ist, dass die Ladezeiten teilweise deutlich kürzer sind als bei Bootstrap. Dies hat den Grund, da nur die Komponenten geladen werden, welche auch wirklich benötigt werden. Doch auch Bootstrap besitzt gewisse Vorteile, zum Beispiel wird Responsive web design explizit unterstützt. Ausserdem ist Bootstrap das am meisten verbreitete Frontend Framework und bietet daher einen umfassenden Support. Da die Unterstützung von Responsive web design eine wichtige Anforderung userer Webapplikation ist, wurde entschieden Bootstrap zu verwenden.
